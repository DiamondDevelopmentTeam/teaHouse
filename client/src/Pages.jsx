...
import { journalPosts as staticJournalPosts } from './data/journal.js';
    ...
    <PageShell>
      ...
      <section className="page-section">
        ...
        <div className="page-related-grid">
          {related.map((entry) => (
            <Link key={entry.slug || entry.href || `${entry.headline}-${entry.date}`} to={`/news/${entry.slug}`}>
...
export function JournalPage() {
  const posts = staticJournalPosts;
  return (
    <PageShell>
